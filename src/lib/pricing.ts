...
export const PRICING_FAQ = [
  ...
  { q: 'Can I remove the "Powered by OyeChats" branding?', a: 'Yes, as a paid add-on on any paid plan. It costs ₹499 (or $5 for international customers) per month per workspace and is not bundled into any plan. Switch it on from the Billing page and the badge inside the widget disappears.' },
